...
public abstract class ASMLCommand implements ScriptCommand, ContextProvider {
	...
	public boolean execute(Context context) {
		...
		LOG.info("Старт выполнения ASML команды '{}'", this.getClass().getSimpleName());
	...
	protected void executeInternal() throws InvokeException {
		...
		LOG.info(AdditionalData.DEBUG_MARKER, "Выполняется команда '{}'", this.getClass().getSimpleName());
	}

	protected void logInformation(String infoToLog) {

		LOG.info(AdditionalData.DEBUG_MARKER, infoToLog);
	}
